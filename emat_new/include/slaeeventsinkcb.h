///////////////////////////////////////////////////////////////////////////////
/*! \file   slaeeventsinkcb.h
*  \author Michael Schlemper
*  \date   08.09.2006
*  \brief  Headerfile for class SlAeEventSinkCB
*
...
#if !defined SLAEEVENTSINKCB_H_
#define SLAEEVENTSINKCB_H_
...
class SlAeEventSinkCBImpl;


/*! \class SlAeEventSinkCB
*  \brief Delivers notification when new alarm event arrives.
*/
class SL_AE_SVC_ADAP_EXPORTS SlAeEventSinkCB
{
...
public:
	...
	SlAeEventSinkCB(void);

	virtual ~SlAeEventSinkCB(void);
	...
	*
	*  Set choosen attributes which will be delivered to the client
	*/
	...
	*
	*  Get choosen attributes which will be delivered to the client
	*/
	...
	*/
	...
	/*! \fn virtual void newEventCB(const QList<SlAeEvent*>& rEventList) = 0;
	*
	*  Sends a new SlAeEvent object to the client object.
	*/
	virtual void newEventCB(const QList<SlAeEvent*>& rEventList) = 0;
...
private:
	...
	SlAeEventSinkCB(const SlAeEventSinkCB& other);
	SlAeEventSinkCB& operator=(const SlAeEventSinkCB& other);

	SlAeEventSinkCBImpl* m_pImpl;
};



#endif //SLAEEVENTSINKCB_H_
