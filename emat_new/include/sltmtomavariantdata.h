// ////////////////////////////////////////////////////////////////////////////
/*! 
  \file   sltmtomavariantdata.h
  \author Reinhold Guenthner
  \date   04.2005
  \brief  Headerfile for class SlTmToMaVariantData, 
          used to handle QVector of QVariant data.
...
#if !defined(SL_TM_TOMA_VARIANT_DATA_H)
#define SL_TM_TOMA_VARIANT_DATA_H
...
/// \brief basic QVector of QVariant for SlTm service storage and interface
typedef QVector<QVariant>  SlTmToMaVariantVVType;  ///< basic QVector of QVariant for SlTm service storage and interface

// ////////////////////////////////////////////////////////////////////////////
/*! 
  \class  SlTmToMaVariantData sltmtomavariantdata.h
  \brief  This is a collection of QVariant data. 
         
  This class consists of a private collection of QVariant data.
  To access data values within collection  
  use methods SlTmToMaVariantData::setVal() and SlTmToMaVariantData::val().
*/
class SL_TM_UTILITIES_EXPORT SlTmToMaVariantData
{
public:
  
  // CREATORS 
  /// \brief constructor
  explicit SlTmToMaVariantData(const int numElements = 0 /*!< number of elements */);
  
  /// \brief copy constructor
  SlTmToMaVariantData(const SlTmToMaVariantData& rSourceObj /*!< source object */);
  
  /// \brief destructor
  virtual ~SlTmToMaVariantData();
  

  // MANIPULATORS 
  // operator=
  /// \brief writes a copy of \a rSourceObj to member data
  SlTmToMaVariantData& operator= (const SlTmToMaVariantData& rSourceObj /*!< source object */);
  ...
  /// \brief set single QVariant member value addressed by \a idx with value 
  ...
  /// \brief set all member QVariant values with values 
  ...
  ///
  /// see QDataStream& operator>> (QDataStream& rStream, SlTmToMaVariantData& rData)
  ...
  /// \brief get single QVariant member value as QVariant addressed by \a idx  
  ...
  ///        This method has been made for internal use only and may be changed or canceled at any time. It is hidden in Open Architecture Documentation.
  ///
  /// see QTextStream& operator<< (QTextStream& rStream, const SlTmToMaVariantData& rData)
  ...
  ///        This method has been made for internal use only and may be changed or canceled at any time. It is hidden in Open Architecture Documentation.
  ///
  /// see QDataStream& operator<< (QDataStream& rStream, const SlTmToMaVariantData& rData)
  ...
  bool operator!= (
        const SlTmToMaVariantData& rRight ///< right object
                  ) const;
  ...
  friend SL_TM_UTILITIES_EXPORT QDataStream& operator>> (QDataStream& rStream, SlTmToMaVariantData& rData);
  friend SL_TM_UTILITIES_EXPORT QTextStream& operator<< (QTextStream& rStream, const SlTmToMaVariantData& rData);
  friend SL_TM_UTILITIES_EXPORT QDataStream& operator<< (QDataStream& rStream, const SlTmToMaVariantData& rData);
...
private:
  ...
  int copyMemberVars( 
              const SlTmToMaVariantData& rSourceObj  /*!< source object */
                    );
  ...
  // MEMBER DATA
  SlTmToMaVariantVVType m_Value;     ///< QVector collection of QVariant data
...
SL_TM_UTILITIES_EXPORT QDataStream& operator>> (QDataStream& rStream,          /*!< binary data stream source */
                                                SlTmToMaVariantData& rData     /*!< import target object */
                                               );
...
SL_TM_UTILITIES_EXPORT QTextStream& operator<< (QTextStream& rStream,                /*!< text data stream target */
                                                const SlTmToMaVariantData& rData     /*!< export source object */
                                               );
...
// end of class SlTmToMaVariantData
// ////////////////////////////////////////////////////////////////////////////
...
#endif // !defined(SL_TM_TOMA_VARIANT_DATA_H)
