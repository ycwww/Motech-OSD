 ...
 *  \date   16.07.07
 *
 *  Header-File trip recorder svc-adapter: Interface class ACE-Service-Adapter
*/
#if !defined(SLTRPSVC_H)
#define SLTRPSVC_H
...
// export class name "SlTrp" for trip-recorder users
...
class SlTrpPrivate;   // forward declaration to private data
class SlTrpCB;        // forward declaration to callback class
class SlTrpCBPrivate; // forward declaration to private data of callback class

/*! \class SlTrp  sltrpsvc.h
 *
 *  Exported ACE-interface trip recorder service
*/
class SL_TRP_ADAPTER_EXPORT SlTrp
{
public:
  ///////////////////////////////////////////////////////////////////////////
  // CREATORS
  ...
  */
   ...
   *  \param trpUsrVarMap& in:map containing user monitoring variable info.V2 version supports user comment
   *  \retval SlTrpErrorEnum   trip recoder errorcode
   */
   ...
   *  \param  pucTripIds  out: buffer for current trace ids
   *  \param  lMaxTripId  in: maximal number of trace ids
   *  \param trpUsrVarMap& out:Map containing user monitoring variable info
   *  \retval SlTrpErrorEnum   trip recoder errorcode
   */
  ...
  */
  ...
  /*! \fn void setAsyncFuncCB(void (*onProgressInfo)(...), void (*onAsyncFinished)(...))
   *
   *  Sets Callback-Functions to get progress or finished informations of async. calls. Used for
   *  services without QT-Signal-Slot-mechanism.
   *
   *  \param  onProgressInfo       in: callback for progress informations
   *  \param  onAsyncFinished      in: callback for finsished information
   *
   */
  void setAsyncFuncCB(void (*onProgressInfo)(long lAsyncHandle, float fProgress), 
                      void (*onAsyncFinished)(long lAsyncHandle, SlTrpErrorEnum Error));

  /*! \fn void setOptionsChangedCB(void (*onOptionsChanged)(...))
   *
   *  Sets Callback-Functions to get options changed informations. Used for
   *  services without QT-Signal-Slot-mechanism.
   *
   *  \param  onOptionsChanged      in: callback for options changed informations
   *
   */
  void setOptionsChangedCB(void (*onOptionsChanged)(const SlTrpOptionsType& tripOptions, const unsigned char *pucTripIds));

  /*! \fn void setStatusChangedCB(void (*onStatusChanged)(bool bTripActive));
   *
   *  Sets Callback-Functions to get status changed informations. Used for
   *  services without QT-Signal-Slot-mechanism.
   *
   *  \param  onStatusChanged      in: callback for status changed informations
   *
   */
  void setStatusChangedCB(void (*onStatusChanged)(bool bTripActive));

  /*! \fn void setCrashLogCB(void (*onCrashLog)(long lAlarmNo));
  *
  *  Sets Callback-Functions to get a signal when a crash log has been generated
  *
  *  \param  onCrashLog      in: callback function, see SlTrpCB for parameter description
  *
  */
  void setCrashLogCB(void (*onCrashLog)(long lAlarmNo));

  /*! \fn void setSaveStatusChangedCB(SlTrpLogFileEnum eLogFile, bool bSaved);
  *
  *  Sets Callback-Functions to get a signals when a log has been saved to disk or when there are new unsaved data
  *
  *  !!! NOT IMPLEMENTED YET !!! RESERVED FOR LATER USE !!!
  *
  *  \param  onSaveStateChanged      in: callback function, see SlTrpCB for parameter description
  *
  */
  void setSaveStatusChangedCB(void (*onSaveStateChanged)(SlTrpLogFileEnum eLogFile, bool bSaved));

  /*! \fn void onChangedAfterLastGet (SlTrpLogFileEnum eLogFile);
  *
  *  Sets Callback-Functions to get a signals when a log has been changed after a getLog()-call
  *
  *  !!! NOT IMPLEMENTED YET !!! RESERVED FOR LATER USE !!!
  *
  *  \param  onChangedAfterLastGet      in: callback function, see SlTrpCB for parameter description
  *
  */
  void setChangedAfterLastGetCB(void (*onChangedAfterLastGet)(SlTrpLogFileEnum eLogFile));

  /*! \fn void onNewEntryNoParam (long lUserId, long eTraceId, long lTraceLevel);
  *
  *  Sets Callback-Functions to get a signal when a new Entry has been logged
  *
  *  !!! NOT IMPLEMENTED YET !!! RESERVED FOR LATER USE !!!
  *
  *  \param  onNewEntryNoParam      in: callback function, see SlTrpCB for parameter description
  *  \param  onNewEntry             in: callback function, see SlTrpCB for parameter description
  *
  */
  void setNewEntryCB(void (*onNewEntryNoParam)(long lUserId, long eTraceId, long lTraceLevel),
  ...
  *
  *  Sets Callback-Functions to get a signal while an active getXXXLogXXX(): an Entry has been read from binary log
  *  Used for implementing an own log file view.
  *
  *  !!! NOT IMPLEMENTED YET !!! RESERVED FOR LATER USE !!!
  *
  *  \param  onGetLogEntryNoParam      in: callback function, see SlTrpCB for parameter description
  *  \param  onGetLogEntry             in: callback function, see SlTrpCB for parameter description
  *
  */
  void setGetLogEntryCB(void (*onGetLogEntryNoParam)(SlTrpLogFileEnum eLogFile, long lAsyncHandle, long lUserId, long eTraceId, long lTraceLevel),
  ...
  /*! \fn void newStatusChangedCB(void (*onStatusChanged)(bool bTripActive));
  *
  *  Sets Callback-Functions to get status changed informations. Used for
  *  services without QT-Signal-Slot-mechanism.
  *
  ...
  *
  */
  void setCBIface(SlTrpCB *pCBIface);
...
protected:
  ...
  /*! \fn virtual void customEvent(QEvent* pCustomEvent);
    *
    *  accessed by the callbackobject for putting events to service-adapter client
    *
...
protected:
  ...
  SlTrpPrivate*               m_pData;                // d-pointer
  QMutex                      m_pDataMutex;           // d-pointer mutex
};


/*! \class SlTrpCB  sltrpsvc.h
*
*  Exported ACE-interface callback class of trip recorder service
*/
class SL_TRP_ADAPTER_EXPORT SlTrpCB
{
public:
  ///////////////////////////////////////////////////////////////////////////
  // CREATORS
  ...
  *
  */
  virtual void onProgressInfo (long lAsyncHandle, float fProgress);
  ...
  *
  */
  virtual void onAsyncFinished (long lAsyncHandle, SlTrpErrorEnum Error);
  ...
  *
  */
  virtual void onOptionsChanged (const SlTrpOptionsType& tripOptions, const unsigned char *pucTripIds);
  ...
  *
  */
  virtual void onStatusChanged (bool bTripActive);
  ...
  *
  */
  virtual void onCrashLog(long lAlarmNo);
  ...
  *  !!! NOT IMPLEMENTED YET !!! RESERVED FOR LATER USE !!!
  *
  *  \param  eLogFile       in: logfile-id
  *  \param  bSaved         in: true=all data have been saved, false=there are unsaved data
  *
  */
  virtual void onSaveStateChanged(SlTrpLogFileEnum eLogFile, bool bSaved);
  ...
  *
  */
  virtual void onChangedAfterLastGet (SlTrpLogFileEnum eLogFile);
  ...
  *
  */
  virtual void onNewEntryNoParam(long lUserId, long eTraceId, long lTraceLevel);
  ...
  *
  */
  virtual void onNewEntry(long lUserId, long eTraceId, long lTraceLevel, const void *traceParam);
  ...
  *
  */
  virtual void onGetLogEntryNoParam(SlTrpLogFileEnum eLogFile, long lAsyncHandle, long lUserId, long eTraceId, long lTraceLevel);
  ...
  *
  */
  virtual void onGetLogEntry(SlTrpLogFileEnum eLogFile, long lAsyncHandle, long lUserId, long eTraceId, long lTraceLevel, const void *traceParam);

private:
  SlTrpCBPrivate*     m_pData;  // d-pointer to private member variables
};
