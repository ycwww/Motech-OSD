...
public:
    ...
    void setupUi(QWidget *emat_newClass)
    {
        ...
        ptn_measure_param = new QPushButton(layoutWidget);
        ptn_measure_param->setObjectName(QString::fromUtf8("ptn_measure_param"));

        horizontalLayout->addWidget(ptn_measure_param);
    ...
    void retranslateUi(QWidget *emat_newClass)
    {
        ...
        ptn_measure_param->setText(QCoreApplication::translate("emat_newClass", "\346\265\213\351\207\217\345\217\202\346\225\260\350\256\276\347\275\256", nullptr));
